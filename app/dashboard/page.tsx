            ...
            <div className="p-5 overflow-y-auto flex-1">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    readOnly
                    value={viewingOffer.job_description || ""}
                    rows={4}
                    className="w-full bg-[#f7f7f7] border border-[#424242]/10 rounded-xl px-4 py-2.5 text-[14px] focus:outline-none transition-all cursor-default resize-none"
                  />
                </div>
